...
class MoviesMainActivity : AppCompatActivity(), MoviesMainViewInterface, SearchView.OnQueryTextListener {
  ...
  private fun setupClicks(){
    ...
    top_rated_movies_layout.setOnClickListener{
      val intent = Intent(this, MoviesListActivity::class.java)
      intent.putExtra(getString(R.string.movie_list_type), MovieListType.TopRated.name)
      startActivity(intent)
    }
    ...
    upcoming_movies_layout.setOnClickListener{
      val intent = Intent(this, MoviesListActivity::class.java)
      intent.putExtra(getString(R.string.movie_list_type), MovieListType.Upcoming.name)
      startActivity(intent)
    }
